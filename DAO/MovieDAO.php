...
class MovieDAO
{
    ...
    public function getAll()
    {
        ...
        try
        {
            ...
            $result=$this->connecton->execute($sqlQuery);
        }
        catch(PDOException $ex)
        {
            throw $ex;
  ...
  public function retrieveDataFromAPI ()
    ...
    public function mapout ($value)
    {
        ...
        $resp = array_map(function($p){
            return new Movie($p['id'], $p['title'], $p['overview'],$p['adult'],$p['genreId'] ,$p['originalLanguage'],$p['popularity'],$p['posterPath'],$p['releaseDate'],$p['status']);
        }, $value);
