          ...
          <?php
            if(!empty($_SESSION['loggedUser']))
            {
              ?>
                ...
                <h4 class="text-white" style="display: inline;"><?= "<strong>".$_SESSION['loggedUser']->getUserName()."</strong>"; ?></h4>
              <?php
            }
            else
            {
              ?>
                <h2 style="display: inline;">Bienvenido </h2>
                <h4 class="text-white" style="display: inline;"><strong>invitado</strong></h4>
              <?php
            }
          ?>
     </span>
